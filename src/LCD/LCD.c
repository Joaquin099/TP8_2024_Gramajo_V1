...
#define LCD_RCC_GPIO_CONTROL RCC_AHB1Periph_GPIOB
...
//--------- DATA PINs (D4~D7) ------------
#define LCD_RCC_GPIO_DATA	(RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOB | RCC_AHB1Periph_GPIOC)
...
void LCD_init(void)
{
	...
	RCC_AHB1PeriphClockCmd(LCD_RCC_GPIO_DATA, ENABLE);
